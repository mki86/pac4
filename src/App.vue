<template>
  <div id="app">
    <div class="header">
       <img class="logo" src="@/assets/uoc-logo.png" alt="UOC" @click="recargar"/>
...
export default defineComponent({
  ...
  methods: {
    ...
    //mostrar receptes de la API
    async getRecetas(){
      const recipeList = await axios.get("http://localhost:3000/recipes") //truca a la API de les receptes per mostra-les
    ...
    recipeListFiltered() {
      ...
      return this.recipeList.filter((recipe) => {
        return (
          ...
          recipe.ingredients.find(ingredient => ingredient.includes(this.searchTerm))
        );
      });
    },
  },
